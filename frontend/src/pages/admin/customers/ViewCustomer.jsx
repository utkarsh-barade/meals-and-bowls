    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="md:col-span-1">
          <Card.Body className="flex flex-col items-center justify-center pt-8 py-8">
            <h2 className="text-card-title text-center break-words w-full">{customer.fullName}</h2>
